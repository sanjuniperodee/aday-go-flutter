...
ActiveRequestDomain orderRequestHistoryMapper(
  OrderRequestHistoryModel model,
  UserModel? userModel,
) =>
    ActiveRequestDomain(
      whatsappUser: null, // Для истории водителя клиент не нужен
      driver: userModel != null ? userMapper(userModel) : null, // Для истории водителя это клиент
