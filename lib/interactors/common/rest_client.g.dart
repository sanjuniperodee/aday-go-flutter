...
class _RestClient implements RestClient {
  ...
  Future<SignInByPhoneResponseModel> signInByPhone(
    ...
    final _options = _setStreamType<SignInByPhoneResponseModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    late SignInByPhoneResponseModel _value;
    try {
      _value = SignInByPhoneResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<SignInByPhoneConfirmCodeResponseModel> signInByPhoneConfirmCode({
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late SignInByPhoneConfirmCodeResponseModel _value;
    try {
      _value = SignInByPhoneConfirmCodeResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<List<OrderRequestResponseModel>> getPendingOrderRequests() async {
    ...
    final _options = _setStreamType<List<OrderRequestResponseModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late List<OrderRequestResponseModel> _value;
    try {
      _value = _result.data!
          .map((dynamic i) =>
  ...
  Future<void> rejectOrderByClientRequest(
      {required String orderRequestId}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<void>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'v1/order-requests/cancel/${orderRequestId}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<ActiveRequestModel> getMyActiveOrder() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ActiveRequestModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ActiveRequestModel _value;
    try {
      _value = ActiveRequestModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<ActiveClientRequestModel> getMyClientActiveOrder() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ActiveClientRequestModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
        .compose(
          _dio.options,
          'v1/order-requests/client-active-order',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ActiveClientRequestModel _value;
    try {
      _value = ActiveClientRequestModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<void> deleteDriverCategory({required String id}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<List<DriverRegisteredCategoryModel>>
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<DriverRegisteredCategoryModel> _value;
    try {
      _value = _result.data!
          .map((dynamic i) =>
  ...
  @override
  Future<void> saveFirebaseDeviceToken({required String deviceToken}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<FoodsResponseModel> fetchFoods() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<FoodsResponseModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late FoodsResponseModel _value;
    try {
      _value = FoodsResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<void> createDriverOrder({required Map<String, dynamic> body}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    ...
    final _options = _setStreamType<void>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'v1/order-requests/create-order',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  @override
  Future<void> makeReview({required Map<String, dynamic> body}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<List<OpenStreetMapPlaceModel>> getPlacesQuery({
    ...
    final _options = _setStreamType<List<OpenStreetMapPlaceModel>>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'v1/order-requests/find-by-name',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
